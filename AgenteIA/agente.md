...
## Estructura de Skills Web

- [web_design.md](AgenteIA/skills/web_design.md): Reglas estéticas y de componentes web.
- [deploy.md](AgenteIA/skills/deploy.md): Proceso de publicación en GitHub Pages / Servidor.
- [ecommerce.md](AgenteIA/skills/ecommerce.md): Lógica de ventas y suscripciones.
